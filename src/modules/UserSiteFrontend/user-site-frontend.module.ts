...
import { UserSiteFrontendController } from './user-site-frontend.controller';
...
@Module({
    ...
    controllers: [UserSiteFrontendController],
    providers: [UserSiteFrontendService, JwtHelper]
})

export class UserSiteFrontendModule { }
